...
<a href="apinputs?mode=del"  class="btn-square-select">削除</a>
   ...
   <div class="Form-Item">
       ...
       <input type="text" class="Form-Item-Input-Long"  name="syainid" value = "{{$apinputs->id}}">

   </div>

   <div class="Form-Item">
       <p class="Form-Item-Label"><span class="Form-Item-Label-Required">入力者氏名</span></p>
       <input type="text" class="Form-Item-Input-Long"  name="namekanji"  value = "{{$apinputs->syain_nm}}">
   </div>
   ...
   <div class="Form-Item">
       ...
       <select name="sex"  class="Form-Item-Input">
         ...
         <option>{{$tsts->branch_id}} : {{$tsts->branch_nm}}</option>
  @endforeach
       </select>
   </div>
...
<form action="regist" id="create-account" method="POST">
  @csrf
   ...
   <div class="Form-Item">
     ...
     <input type="submit" class="btn-square"  name="regist" value="更新">
   </div>
