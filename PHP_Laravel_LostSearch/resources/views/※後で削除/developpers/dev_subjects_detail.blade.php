...
<a href="apinputs?mode=ref"  class="btn-square-select">照会aaaa</a>
<a href="apinputs?mode=ins"  class="btn-square-select">登録fff</a>
<a href="apinputs?mode=upd"  class="btn-square-select">修正sss</a>
<a href="apinputs?mode=del"  class="btn-square-select">削除ssss</a>
...
<!--修正モード-->
 <div class="Form">
  ...
  <div class="Form-Item">
       <p class="Form-Item-Label"><span class="Form-Item-Label-Required">プロジェクトうぇええええ</span></p>
...
<body>
  <div class="form_container">
    <form action="search" id="create-account" method="POST">
     ...
     <input type="submit" class="btn-square"  name="search" value="選択">
   </div>
