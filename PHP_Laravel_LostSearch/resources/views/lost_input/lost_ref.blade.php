...
<form action="lost_search" id="lost_search" method="POST"    enctype="multipart/form-data">
   ...
   <input type="hidden"  name="hidden_mode"  value="{{$mode}}">
   <input type="hidden"  name="hidden_flg"  value="{{$flg}}">
</form>
...
<div class="lostlist">
  <ul>
    <li>  <a href="lost_input_ref?id={{$id}}&lost_no={{$lostdatas->ref_lost_no}}&mode=ref&flg=true">
